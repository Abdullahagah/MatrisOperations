...
void input_Array(int arrAl[100][100],int row,int column);
...
void finder_Max_Element_Rows_Columns(int arr[100][100],int row,int column); // yarýda kaldi
...
void finder_Product_Of_Two_Arrays(int arr[100][100],int row,int column,int arr2[100][100],int row2,int column2); //yarýda kaldý
